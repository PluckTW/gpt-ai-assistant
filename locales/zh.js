const zh = {
  ...
  __COMMAND_GAME_ENTER_LABEL: '魔奇獸冒險',
  __COMMAND_GAME_ENTER_TEXT: '/game',
  __COMMAND_GAME_ENTER_ALIASES: ['魔奇獸', '開始冒險'],
  __COMMAND_GAME_STATUS_LABEL: '角色狀態',
  __COMMAND_GAME_STATUS_TEXT: '/game 狀態',
  __COMMAND_GAME_STATUS_ALIASES: ['冒險者狀態', '角色狀態'],
  __COMMAND_GAME_MAP_LABEL: '選擇章節',
  __COMMAND_GAME_MAP_TEXT: '/game 地圖',
  __COMMAND_GAME_MAP_ALIASES: ['選擇地圖', '章節選擇'],
  __COMMAND_GAME_CHALLENGE_LABEL: '挑戰',
  __COMMAND_GAME_CHALLENGE_TEXT: '挑戰',
  __COMMAND_GAME_UPGRADE_LABEL: '升級魔法球',
  __COMMAND_GAME_UPGRADE_TEXT: '/game 升級',
  __COMMAND_GAME_UPGRADE_ALIASES: ['魔法球升級', '升級魔法球'],
